...
// Source: https://www.cazzulino.com/git-info-from-msbuild-and-code.html
partial class ThisAssembly
{
    ...
    /// </summary>
    public const string Version = SimpleVersion + (Git.Commits != "0" ? "." + Git.Commits : "");
    
    /// <summary>
    /// Full version, plus branch and commit short sha, like 4.0.1.598-cycle6+39cf84e
    /// </summary>
    public const string InformationalVersion = Version + (Git.Branch != "main" ? "-" + Git.Branch : "") + "+" + Git.Commit;
}
